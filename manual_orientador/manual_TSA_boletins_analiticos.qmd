...
<div class="screenshot-box">
  ...
  <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem; padding:1rem;">
    <div>
      ...
      <img src="ref/images/boletim_definitivo.png" alt="Boletim Definitivo" style="width:100%; border:1px solid #dee2e6; border-radius:4px;"/>
    </div>
    <div>
      <p style="text-align:center; font-size:0.82rem; color:#555; margin-bottom:0.4rem;">Boletim Provisório</p>
      <img src="ref/images/boletim_provisorio.png" alt="Boletim Provisório" style="width:100%; border:1px solid #dee2e6; border-radius:4px;"/>
    </div>
  </div>
</div>
```
